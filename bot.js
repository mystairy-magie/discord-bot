...
s4d.client.login('ODYwMTgxOTY4NDM5MjE0MTAw.YN3g4g.M29w2Lt5kBLBG3tjmU1q4xc9WaE').catch((e) => { s4d.tokenInvalid = true; s4d.tokenError = e; });
...
s4d.client.on('message', async (s4dmessage) => {
  ...
  if (String((s4dmessage.content)).includes(String('m/'))) {
    if (String(((s4dmessage.channel || {}).name)).includes(String('ticket-'))) {
      ...
      Salon_message__22_3E_22.bulkDelete((1|1))await delay(Number(2)*1000);
